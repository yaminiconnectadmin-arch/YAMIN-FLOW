                    ...
                    <div className="mt-0.5">
                      <span className={`px-2 py-0.5 rounded text-xs font-bold uppercase font-mono ${
                        selected.status === "pending"
                          ? (selected.reservation_status === "reserved" ? "bg-amber-100 text-amber-900 border border-amber-300" : selected.reservation_status === "partially_reserved" ? "bg-amber-100 text-amber-900 border border-amber-300" : "bg-red-100 text-red-800")
                          : (selected.reservation_status === "reserved" ? "bg-emerald-100 text-emerald-800" : selected.reservation_status === "partially_reserved" ? "bg-amber-100 text-amber-800" : "bg-red-100 text-red-800")
                      }`}>
                        {selected.status === "pending"
                          ? (selected.reservation_status === "reserved" ? "STOCK BOOKED (APPROVAL PENDING)" : selected.reservation_status === "partially_reserved" ? "PARTIAL STOCK BOOKED (APPROVAL PENDING)" : "PENDING REPLENISHMENT")
